...
namespace oct::cc::tt::a::gram
{
	...
	static const cc::tt::b::TT<tt::Tokens,tt::Tokens> list_insts{
		...
		{0,Tokens::i8086_mov,Indicator::None,1,Tokens::none},
			...
			//register,inmendiate
			{4,Tokens::regs_8,Indicator::None,5,Tokens::none},
			{4,Tokens::regs_16,Indicator::None,5,Tokens::none},
			{5,Tokens::Integer_0x,Indicator::Accept,6,Tokens::none},
			{5,Tokens::Integer,Indicator::Accept,6,Tokens::none},
			{5,Tokens::i8086_reg_ax,Indicator::Accept,6,Tokens::none},
			{6,(Tokens)' ',Indicator::Prev_Eat,6,(Tokens)' '},
			{6,(Tokens)'\n',Indicator::Prev_Eat,6,(Tokens)'\t'},
			{6,(Tokens)'\t',Indicator::Prev_Eat,6,(Tokens)'\n'},
