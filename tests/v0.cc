...
void v0_developing()
{
	...
	*/
	...
	CU_ASSERT(af_number.transition("123456") == 6);
	CU_ASSERT(af_number.transition("0123456") == 7);
	//no pertenice al lenguaje
	CU_ASSERT(af_number.transition("A123456") == 0);
	CU_ASSERT(af_number.transition("0x123456") == 1);
	...
	//pertenice al lenguaje
	CU_ASSERT(af_numberL.transition(L"123456") == 6);
	CU_ASSERT(af_numberL.transition(L"0123456") == 7);
	CU_ASSERT(af_numberL.transition(L"A123456") == 0);
	CU_ASSERT(af_numberL.transition(L"0x123456") == 1);
	...
	CU_ASSERT(af_hex.transition("0x123F5A") == 8);
	CU_ASSERT(af_hex.transition("0x01") == 4);
	//reject
	...
	CU_ASSERT(af_hex2.transition("0X123F5A")  == 8);
	CU_ASSERT(af_hex2.transition("0x01") == 4);
	//reject
	...
	CU_ASSERT(af_hex2L.transition(L"0X123F5A") == 8);
	CU_ASSERT(af_hex2L.transition(L"0x01") == 4);
	//reject
	...
	CU_ASSERT(instruction_set_i86.transition("aaa") == 3);
	CU_ASSERT(instruction_set_i86.transition("aAa") == 0);
	CU_ASSERT(instruction_set_i86.transition("AAA") == 0);
	CU_ASSERT(instruction_set_i86.transition("ana") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("aad") == 3);
	CU_ASSERT(instruction_set_i86.transition("AAD") == 0);
	CU_ASSERT(instruction_set_i86.transition("AAd") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("aam") == 3);
	CU_ASSERT(instruction_set_i86.transition("AAM") == 0);
	CU_ASSERT(instruction_set_i86.transition("AaM") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("adc") == 3);
	CU_ASSERT(instruction_set_i86.transition("ADC") == 0);
	CU_ASSERT(instruction_set_i86.transition("aDc") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("add") == 3);
	CU_ASSERT(instruction_set_i86.transition("ADD") == 0);
	CU_ASSERT(instruction_set_i86.transition("aDd") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("and") == 3);
	CU_ASSERT(instruction_set_i86.transition("AND") == 0);
	CU_ASSERT(instruction_set_i86.transition("aNd") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("call") == 4);
	CU_ASSERT(instruction_set_i86.transition("CALL") == 0);
	CU_ASSERT(instruction_set_i86.transition("Call") == 0);
	CU_ASSERT(instruction_set_i86.transition("CaLL") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("cbw") == 3);
	CU_ASSERT(instruction_set_i86.transition("CBW") == 0);
	CU_ASSERT(instruction_set_i86.transition("cBW") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("clc") == 3);
	CU_ASSERT(instruction_set_i86.transition("cLc") == 0);
	CU_ASSERT(instruction_set_i86.transition("CLC") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("cld") == 3);
	CU_ASSERT(instruction_set_i86.transition("cLd") == 0);
	CU_ASSERT(instruction_set_i86.transition("CLD") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("cli") == 3);
	CU_ASSERT(instruction_set_i86.transition("cLi") == 0);
	CU_ASSERT(instruction_set_i86.transition("CLI") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("cmc") == 3);
	CU_ASSERT(instruction_set_i86.transition("cmC") == 0);
	CU_ASSERT(instruction_set_i86.transition("CMC") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("cmp") == 3);
	CU_ASSERT(instruction_set_i86.transition("cmP") == 0);
	CU_ASSERT(instruction_set_i86.transition("CMP") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("cmps") == 4);
	CU_ASSERT(instruction_set_i86.transition("cmPs") == 0);
	CU_ASSERT(instruction_set_i86.transition("CMPS") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("cwd") == 3);
	CU_ASSERT(instruction_set_i86.transition("CWw") == 0);
	CU_ASSERT(instruction_set_i86.transition("CWD") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("daa") == 3);
	CU_ASSERT(instruction_set_i86.transition("DAA") == 0);
	CU_ASSERT(instruction_set_i86.transition("DaA") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("das") == 3);
	CU_ASSERT(instruction_set_i86.transition("DAs") == 0);
	CU_ASSERT(instruction_set_i86.transition("DaS") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("dec") == 3);
	CU_ASSERT(instruction_set_i86.transition("DeC") == 0);
	CU_ASSERT(instruction_set_i86.transition("Dec") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("div") == 3);
	CU_ASSERT(instruction_set_i86.transition("Div") == 0);
	CU_ASSERT(instruction_set_i86.transition("diV") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("esc") == 3);
	CU_ASSERT(instruction_set_i86.transition("ESC") == 0);
	CU_ASSERT(instruction_set_i86.transition("Esc") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("hlt") == 3);
	CU_ASSERT(instruction_set_i86.transition("Hlt") == 0);
	CU_ASSERT(instruction_set_i86.transition("HLT") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("idiv") == 4);
	CU_ASSERT(instruction_set_i86.transition("iDiv") == 0);
	CU_ASSERT(instruction_set_i86.transition("idiV") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("imul") == 4);
	CU_ASSERT(instruction_set_i86.transition("iMul") == 0);
	CU_ASSERT(instruction_set_i86.transition("IMUL") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("in") == 2);
	CU_ASSERT(instruction_set_i86.transition("iN") == 0);
	CU_ASSERT(instruction_set_i86.transition("IN") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("inc") == 3);
	CU_ASSERT(instruction_set_i86.transition("iNc") == 0);
	CU_ASSERT(instruction_set_i86.transition("INc") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("int") == 3);
	CU_ASSERT(instruction_set_i86.transition("iNt") == 0);
	CU_ASSERT(instruction_set_i86.transition("INt") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("intr") == 4);
	CU_ASSERT(instruction_set_i86.transition("iNtr") == 0);
	CU_ASSERT(instruction_set_i86.transition("INtr") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("into") == 4);
	CU_ASSERT(instruction_set_i86.transition("iNto") == 0);
	CU_ASSERT(instruction_set_i86.transition("INto") == 0);
	
	CU_ASSERT(instruction_set_i86.transition("iret") == 4);
	CU_ASSERT(instruction_set_i86.transition("IRET") == 0);
	CU_ASSERT(instruction_set_i86.transition("Iret") == 0);
	

	AFA regs_i86(tt::i86_regs_l);
	CU_ASSERT(regs_i86.transition("ax") == 2);
	CU_ASSERT(regs_i86.transition("ah") == 2);
	CU_ASSERT(regs_i86.transition("al") == 2);
	CU_ASSERT(regs_i86.transition("bx") == 2);
	CU_ASSERT(regs_i86.transition("bh") == 2);
	CU_ASSERT(regs_i86.transition("bl") == 2);
	CU_ASSERT(regs_i86.transition("cx") == 2);
	CU_ASSERT(regs_i86.transition("ch") == 2);
	CU_ASSERT(regs_i86.transition("cl") == 2);
	CU_ASSERT(regs_i86.transition("dx") == 2);
	CU_ASSERT(regs_i86.transition("dh") == 2);
	CU_ASSERT(regs_i86.transition("dl") == 2);

	AFA AF_id(tt::Identifier);
	CU_ASSERT(AF_id.transition("ax") == 2);
	CU_ASSERT(AF_id.transition("ah") == 2);
	CU_ASSERT(AF_id.transition("al") == 2);
	CU_ASSERT(AF_id.transition("bx") == 2);
	CU_ASSERT(AF_id.transition("bh") == 2);
	CU_ASSERT(AF_id.transition("bl") == 2);
	CU_ASSERT(AF_id.transition("cx") == 2);
	CU_ASSERT(AF_id.transition("ch") == 2);
	CU_ASSERT(AF_id.transition("cl") == 2);
	CU_ASSERT(AF_id.transition("dx") == 2);
	CU_ASSERT(AF_id.transition("dh") == 2);
	CU_ASSERT(AF_id.transition("dl") == 2);
	
	CU_ASSERT(AF_id.transition("JUAN") == 4);
	CU_ASSERT(AF_id.transition("Carro") == 5);
	CU_ASSERT(AF_id.transition("_Test12") == 7);
	CU_ASSERT(AF_id.transition("_Avion_") == 7);
	CU_ASSERT(AF_id.transition("Aeropueto") == 9);
	CU_ASSERT(AF_id.transition("REF_00256") == 9);
	CU_ASSERT(AF_id.transition("REF_08956") == 9);
	CU_ASSERT(AF_id.transition("Romero1") == 7);
	CU_ASSERT(AF_id.transition("Romero1!") == 7);
	CU_ASSERT(AF_id.transition("1Romero1") == 0);


	AFA AF_segs(tt::i86_segs_l);
	CU_ASSERT(AF_segs.transition("es") == 2);
	CU_ASSERT(AF_segs.transition("ss") == 2);
	CU_ASSERT(AF_segs.transition("ds") == 2);
	CU_ASSERT(AF_segs.transition("cs") == 2);
	
	CU_ASSERT(AF_segs.transition("sp") == 2);
	CU_ASSERT(AF_segs.transition("bp") == 2);
