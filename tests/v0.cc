...
void v0_AA()
{
	...
	CU_ASSERT((int)A_here::Tokens::BREAK == (int)yytoken_kind_t::BREAK);
	//std::cout << "BREAK : " << (int)A_here::Tokens::BREAK << " " << (int)yytoken_kind_t::BREAK << "\n";
	
	CU_ASSERT((int)A_here::Tokens::CASE == (int)yytoken_kind_t::CASE);
	//std::cout << "CASE : " << (int)A_here::Tokens::CASE << " " << (int)yytoken_kind_t::CASE << "\n";
	
	CU_ASSERT((int)A_here::Tokens::CHAR == (int)yytoken_kind_t::CHAR);
	//std::cout << "CHAR : " << (int)A_here::Tokens::CHAR << " " << (int)yytoken_kind_t::CHAR << "\n";
	
	CU_ASSERT((int)A_here::Tokens::CONST == (int)yytoken_kind_t::CONST);
	//std::cout << "CONST : " << (int)A_here::Tokens::CONST << " " << (int)yytoken_kind_t::CONST << "\n";
	
	CU_ASSERT((int)A_here::Tokens::DO == (int)yytoken_kind_t::DO);
