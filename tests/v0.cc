...
void v0_AFD_A()
{
	...
	dfa::A<char> intC_0x(TABLE(tt::a::Integer_0x));
	...
	//Assembler A
	dfa::A<char> i8086_regs(TABLE(a::i8086_regs));
	try
	{
	...
	dfa::A<char> i8086_segs(TABLE(a::i8086_segs));
	...
	*/
	...
	dfa::A<char> i8086_insts(TABLE(a::i8086_insts));
