...
void v0_AFD_A()
{
	...
	CU_ASSERT(i8086_regs.get_actual()->token == tt::Tokens::i8086_reg_ah);
	CU_ASSERT(i8086_regs.transition("al") == 2);
	CU_ASSERT(i8086_regs.get_actual()->token == tt::Tokens::i8086_reg_al);
	...
	CU_ASSERT(i8086_regs.get_actual()->token == tt::Tokens::i8086_reg_bx);
	CU_ASSERT(i8086_regs.transition("bh") == 2);
	CU_ASSERT(i8086_regs.get_actual()->token == tt::Tokens::i8086_reg_bh);
	CU_ASSERT(i8086_regs.transition("bh,") == 2);
	CU_ASSERT(i8086_regs.transition("bl") == 2);
	CU_ASSERT(i8086_regs.get_actual()->token == tt::Tokens::i8086_reg_bl);
	CU_ASSERT(i8086_regs.transition("bl  ") == 2);
	CU_ASSERT(i8086_regs.transition("bl.") == 0);
	CU_ASSERT(i8086_regs.transition("bl-") == 0);
	CU_ASSERT(i8086_regs.transition("cx") == 2);
	CU_ASSERT(i8086_regs.get_actual()->token == tt::Tokens::i8086_reg_cx);
	CU_ASSERT(i8086_regs.transition("cx,") == 2);
	CU_ASSERT(i8086_regs.transition("ch") == 2);
	CU_ASSERT(i8086_regs.get_actual()->token == tt::Tokens::i8086_reg_ch);
	CU_ASSERT(i8086_regs.transition("cl") == 2);
	CU_ASSERT(i8086_regs.transition("cl ") == 2);
	CU_ASSERT(i8086_regs.get_actual()->token == tt::Tokens::i8086_reg_cl);
	CU_ASSERT(i8086_regs.transition("cx;") == 2);
	CU_ASSERT(i8086_regs.get_actual()->token == tt::Tokens::i8086_reg_cx);
	CU_ASSERT(i8086_regs.transition("dx") == 2);
	CU_ASSERT(i8086_regs.get_actual()->token == tt::Tokens::i8086_reg_dx);
	CU_ASSERT(i8086_regs.transition("dx,") == 2);
	CU_ASSERT(i8086_regs.transition("dx  ") == 2);
	//CU_ASSERT(i8080_regs.transition("dx ") == 2);
	CU_ASSERT(i8086_regs.transition("dh") == 2);
	CU_ASSERT(i8086_regs.get_actual()->token == tt::Tokens::i8086_reg_dh);
	CU_ASSERT(i8086_regs.transition("dl") == 2);
	CU_ASSERT(i8086_regs.transition("dl[]") == 0);
	CU_ASSERT(i8086_regs.transition("dl  ") == 2);
	CU_ASSERT(i8086_regs.get_actual()->token == tt::Tokens::i8086_reg_dl);
	CU_ASSERT(i8086_regs.transition("dl	") == 2);
	...
	*/
	...
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_aaa);
	CU_ASSERT(i8086_insts.transition("aaa;") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_aaa);
	CU_ASSERT(i8086_insts.transition("aaa ") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_aaa);
	...
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_aad);
	CU_ASSERT(i8086_insts.transition("aam") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_aam);
	CU_ASSERT(i8086_insts.transition("aas") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_aas);
	CU_ASSERT(i8086_insts.transition("adc") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_adc);
	CU_ASSERT(i8086_insts.transition("add") == 3);	
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_add);
	CU_ASSERT(i8086_insts.transition("and") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_and_token);
	CU_ASSERT(i8086_insts.transition("call") == 4);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_call);
	CU_ASSERT(i8086_insts.transition("calling") == 0);
	CU_ASSERT(i8086_insts.transition("cbw") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_cbw);
	CU_ASSERT(i8086_insts.transition("cbwl") == 0);	
	CU_ASSERT(i8086_insts.transition("clc") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_clc);
	CU_ASSERT(i8086_insts.transition("cld") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_cld);
	CU_ASSERT(i8086_insts.transition("cli") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_cli);
	CU_ASSERT(i8086_insts.transition("cmc") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_cmc);
	CU_ASSERT(i8086_insts.transition("cmp") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_cmp);
	CU_ASSERT(i8086_insts.transition("cmps") == 4);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_cmps);
	CU_ASSERT(i8086_insts.transition("cwd") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_cwd);
	CU_ASSERT(i8086_insts.transition("cw5") == 0);	
	CU_ASSERT(i8086_insts.transition("cwdd") == 0);
	CU_ASSERT(i8086_insts.transition("daa") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_daa);
	CU_ASSERT(i8086_insts.transition("da1") == 0);
	CU_ASSERT(i8086_insts.transition("daaa") == 0);
	CU_ASSERT(i8086_insts.transition("das") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_das);
	CU_ASSERT(i8086_insts.transition("das1") == 0);
	CU_ASSERT(i8086_insts.transition("dec") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_dec);
	CU_ASSERT(i8086_insts.transition("div") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_div);
	CU_ASSERT(i8086_insts.transition("esc") == 3);	
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_esc);
	...
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_idiv);
	CU_ASSERT(i8086_insts.transition("imul") == 4);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_imul);
	CU_ASSERT(i8086_insts.transition("in") == 2);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_in);
	CU_ASSERT(i8086_insts.transition("inc") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_inc);
	CU_ASSERT(i8086_insts.transition("int") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_int_token);
	CU_ASSERT(i8086_insts.transition("intr") == 4);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_intr);
	CU_ASSERT(i8086_insts.transition("into") == 4);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_into);
	CU_ASSERT(i8086_insts.transition("intt") == 0);	
	CU_ASSERT(i8086_insts.transition("ints") == 0);	
	CU_ASSERT(i8086_insts.transition("iret") == 4);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_iret);
	CU_ASSERT(i8086_insts.transition("ja") == 2);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_ja);
	CU_ASSERT(i8086_insts.transition("jae") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jae);
	CU_ASSERT(i8086_insts.transition("jb") == 2);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jb);
	//i8086_insts.enable_echo(true);
	CU_ASSERT(i8086_insts.transition("jbe") == 3);
	//i8086_insts.enable_echo(false);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jbe);
	CU_ASSERT(i8086_insts.transition("jc") == 2);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jc);
	//i8086_insts.enable_echo(true);
	CU_ASSERT(i8086_insts.transition("jcxz") == 4);
	//i8086_insts.enable_echo(false);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jcxz);
	//i8086_insts.enable_echo(true);
	CU_ASSERT(i8086_insts.transition("je") == 2);
	//i8086_insts.enable_echo(false);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_je);
	CU_ASSERT(i8086_insts.transition("jg") == 2);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jg);
	//i8086_insts.enable_echo(true);
	CU_ASSERT(i8086_insts.transition("jge") == 3);
	//i8086_insts.enable_echo(false);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jge);
	CU_ASSERT(i8086_insts.transition("jl") == 2);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jl);
	CU_ASSERT(i8086_insts.transition("jle") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jle);
	CU_ASSERT(i8086_insts.transition("jmp") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jmp);
	CU_ASSERT(i8086_insts.transition("jnc") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jnc);
	CU_ASSERT(i8086_insts.transition("jne") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jne);
	CU_ASSERT(i8086_insts.transition("jno") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jno);
	CU_ASSERT(i8086_insts.transition("jnp") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jnp);
	CU_ASSERT(i8086_insts.transition("jns") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jns);
	CU_ASSERT(i8086_insts.transition("jo") == 2);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jo);
	CU_ASSERT(i8086_insts.transition("jp") == 2);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_jp);
	CU_ASSERT(i8086_insts.transition("js") == 2);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_js);
	CU_ASSERT(i8086_insts.transition("lahf") == 4);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_lahf);
	CU_ASSERT(i8086_insts.transition("lds") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_lds);
	CU_ASSERT(i8086_insts.transition("lea") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_lea);
	CU_ASSERT(i8086_insts.transition("les") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_les);
	CU_ASSERT(i8086_insts.transition("lock") == 4);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_lock);
	CU_ASSERT(i8086_insts.transition("lods") == 4);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_lods);
	CU_ASSERT(i8086_insts.transition("loop") == 4);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_loop);
	CU_ASSERT(i8086_insts.transition("loope") == 5);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_loope);	
	CU_ASSERT(i8086_insts.transition("nmi") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_nmi);
	CU_ASSERT(i8086_insts.transition("mov") == 3);
	CU_ASSERT(i8086_insts.get_actual()->token == tt::Tokens::i8086_mov);
