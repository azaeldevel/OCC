...
namespace oct::cc::v1
{
    void Lexer::rules(std::ostream& out) const
    {
        ...
        out << "{CONSTANT_INTEGER_DEC_8b}  {\n";
                                    ...
                                    out << "\t\tconst_integer->set(yytext,AI_here::nodes::constant_integer<AI_here::integer>::Format::decimal,AI_here::Tokens::CONSTANT_INTEGER_DEC_8b);\n";
                                    out << "\t\tyylval->CONSTANT_INTEGER_DEC_8b = const_integer;\n";
                                    out << "\t\treturn CONSTANT_INTEGER_DEC_8b;\n";
                                out << "\t\t}\n";
        out << "{CONSTANT_INTEGER_DEC_16b}  {\n";
                                    //out << "\t\tstd::cout << \"Line CONSTANT_INTEGER_DEC_16b : \" << yytext << \"\\n\";\n";
                                    out << "\t\tAI_here::nodes::constant_integer<AI_here::integer>* const_integer = tray->block.create<AI_here::nodes::constant_integer<AI_here::integer>>();\n";
                                    out << "\t\tconst_integer->set(yytext,AI_here::nodes::constant_integer<AI_here::integer>::Format::decimal,AI_here::Tokens::CONSTANT_INTEGER_DEC_16b);\n";
                                    out << "\t\tyylval->CONSTANT_INTEGER_DEC_16b = const_integer;\n";
                                    out << "\t\treturn CONSTANT_INTEGER_DEC_16b;\n";
                                out << "\t\t}\n";

        out << "{CONSTANT_INTEGER_HEX_8b}  {\n";
                                    //out << "\t\tstd::cout << \"Line CONSTANT_INTEGER_DEC_8b : \" << yytext << \"\\n\";\n";
                                    out << "\t\tAI_here::nodes::constant_integer<AI_here::integer>* const_integer = tray->block.create<AI_here::nodes::constant_integer<AI_here::integer>>();\n";
                                    out << "\t\tconst_integer->set(yytext,AI_here::nodes::constant_integer<AI_here::integer>::Format::hexadecimal,AI_here::Tokens::CONSTANT_INTEGER_HEX_8b);\n";
                                    out << "\t\tyylval->CONSTANT_INTEGER_HEX_8b = const_integer;\n";
                                    out << "\t\treturn CONSTANT_INTEGER_HEX_8b;\n";
                                out << "\t\t}\n";
        out << "{CONSTANT_INTEGER_HEX_16b}  {\n";
                                    //out << "\t\tstd::cout << \"Line CONSTANT_INTEGER_DEC_16b : \" << yytext << \"\\n\";\n";
                                    out << "\t\tAI_here::nodes::constant_integer<AI_here::integer>* const_integer = tray->block.create<AI_here::nodes::constant_integer<AI_here::integer>>();\n";
                                    out << "\t\tconst_integer->set(yytext,AI_here::nodes::constant_integer<AI_here::integer>::Format::hexadecimal,AI_here::Tokens::CONSTANT_INTEGER_HEX_16b);\n";
                                    out << "\t\tyylval->CONSTANT_INTEGER_HEX_16b = const_integer;\n";
                                    out << "\t\treturn CONSTANT_INTEGER_HEX_16b;\n";
                                out << "\t\t}\n";
