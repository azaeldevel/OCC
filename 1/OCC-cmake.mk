...
$(TARGET_OUTPUT_DIR)AI : 
	mkdir -p $(TARGET_OUTPUT_DIR)AI
...
$(TARGET_OUTPUT_DIR)AI/occ-intel.lexer.cc $(TARGET_OUTPUT_DIR)AI/occ-intel.lexer.hh : $(TARGET_OUTPUT_DIR)AI/intel.l
...
$(TARGET_OUTPUT_DIR)AI/occ-intel.parser.cc (TARGET_OUTPUT_DIR)AI/occ-intel.parser.hh : $(TARGET_OUTPUT_DIR)AI/intel.y
...
all : $(TARGET_OUTPUT_DIR)AI $(TARGET_OUTPUT_DIR)AI/occ-intel.parser.cc (TARGET_OUTPUT_DIR)AI/occ-intel.parser.hh $(TARGET_OUTPUT_DIR)AI/occ-intel.lexer.cc $(TARGET_OUTPUT_DIR)AI/occ-intel.lexer.hh 
